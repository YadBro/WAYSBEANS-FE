                ...
                <div className="d-flex gap-5">
                    ...
                    {contacts.map(item => (
                            <div key={item?.id}>
                                <div className="d-flex p-3">
                                    <img src={process.env.REACT_APP_SERVER_URL_FILE + item?.profile?.image || masTampan} className="rounded-circle" alt="av" width={55} height={55} />
                    ...
                    {contact 
                        ...
                        <div style={{ backgroundColor: "#C4C4C4", borderRadius: "10px 10px 0 0" }}>
                            <div className="d-flex p-3">
                                <img src={process.env.REACT_APP_SERVER_URL_FILE + contact?.profile?.image} className="rounded-circle" alt="av" width={55} height={55} />
