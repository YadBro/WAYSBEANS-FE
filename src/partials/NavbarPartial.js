            ...
            {isLogin === true ? (
              <li className="nav-item me-4">
                <div className="dropdown">
                  <Link
                    to="/mycart"
                    className="btnDrop me-3 text-decoration-none"
                  >
                    <img
                      src={cartPNG}
                      alt="wblogo"
                    ...
                    />
                    <sup
                      className="bg-danger text-white rounded-circle fs-6 position-absolute py-2 px-1"
                      style={{ top: 15, right: 80 }}
                    >
                      {cartData.length}
                    </sup>
                  </Link>
                  ...
                  >
                    <img
                      ...
                      src={preview || masTampanIMG}
                      alt="wblogo"
                      style={{ width: 100, height: 100 }}
                    />
                  </button>
                  <ul
                    className="mt-4 shadow dropdown-menu dropdown-menu-light dropdown-menu-end"
                    aria-labelledby="dropdownMenuButton2"
                    style={{ borderRadius: 10, width: 200, border: 'none' }}
                  >
                    {user?.status === 'seller' && isLogin === true && (
                      <>
                        <li>
                          <Link
                            className="dropdown-item ms-1 p-3 fs-5"
                            to={'/dashboard'}
              ...
              <>
                <li className="nav-item">
                  ...
                  <button
                    type="button"
                    className="nav-link btn-waysbeans"
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                      <div className="modal-content login-box">
                        <div className="modal-body m-3">
                          ...
                          <form
                            onSubmit={(event) => handlerLogin.mutate(event)}
                          >
                            <div className="mb-3">
                              <input
                            ...
                            <div className="mb-3">
                              <input
                                ...
                                name="password"
                                type="password"
                                className="form-input p-3 mt-1 mb-3"
                            ...
                            {isLoading ? (
                              <button
                                type="button"
                                className="btn-waysbeans position-relative btn-active-waysbeans w-100 fs-4 p-4"
                              >
                                <div
                              ...
                              <button
                                type="submit"
                                className="btn-waysbeans btn-active-waysbeans w-100 fs-4 p-4"
                              >
                                Login
                              </button>
                            )}
                            <div className="d-flex justify-content-center mt-3">
                              <p className="login-help">
                                ...
                                <Link
                                  onClick={freshStates}
                                  className="text-decoration-none login-help-link"
                                  to={'#'}
                                  data-bs-toggle="modal"
                ...
                <li className="nav-item">
                  <button
                    type="button"
                    className="nav-link btn-active-waysbeans btn-waysbeans ms-3"
                    data-bs-toggle="modal"
                    data-bs-target="#registerModal"
                  >
                    Register
                    ...
                    <div className="modal-dialog modal-dialog-centered">
                      <div className="modal-content login-box">
                        <div className="modal-body m-3">
                          ...
                          <form
                            onSubmit={(event) => handlerRegister.mutate(event)}
                          >
                            <div className="mb-3">
                              <input
                            ...
                            <div className="mb-3">
                              <input
                                ...
                                name="password"
                                type="password"
                                className="form-input p-3 mt-1 mb-2"
                                autoComplete="current-password"
                                id="@passwordId"
                                placeholder="Password"
                              />
                            ...
                            {isLoading ? (
                              ...
                              <>
                                {notif.success && (
                                  <p
                                    className="text-success text-center fs-5"
                                    style={{ fontWeight: 500 }}
                                  >
                                    {notif.success}
                                  </p>
